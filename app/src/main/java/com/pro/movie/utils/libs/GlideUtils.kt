...
class GlideUtils private constructor() {
    companion object {
        ...
        /**
         * this method is used  to load image with place holder
         * @param imageView : the view where image will load
         * @param source : image url
         */
        fun glideWithPlaceHolder(imageView: ImageView, source: Any){
             var imageUrl = BaseApplication.getBaseApplicationContext()
                     .getString(R.string.image_url) + source
            Glide.with(BaseApplication.getBaseApplicationContext())
                    .asBitmap()
                    .load(imageUrl)
